    ...
    <header>
        ...
        <main>
            ...
            <div class="historia-smak">
                    <section class="sobre">
                        <h1>Bem-vindo à Smak, o melhor restaurante online da região!</h1>
                        <p>Somos um restaurante onde você pode encontrar o melhor da sua vida!</p>
                        <p>No cardapio você vai encontrar deliciosos crepes, bolos e cones trufados. Todos no preço que cabe no bolso e de otima qualidade. Amor é o principal ingrediente da nossa cozinha</p>
                        <p>Tenho a certeza de que essa é a melhor compra que você podia fazer</p>
                        <p>Começamos em 2020 a fim de levar mais sabor para sua vida!</p>
                    </section>
            </div>
        </main>
        <footer>   
